...
__attribute__((__section__(".instruccion"))) static uint32_t my_instruccion_8086[] = {
    ...
    [0x84] = STRING_INSTRU(STRING_INSTRUCTION8086(TEST)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x85] = STRING_INSTRU(STRING_INSTRUCTION8086(TEST)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x86] = STRING_INSTRU(STRING_INSTRUCTION8086(XCHG)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x87] = STRING_INSTRU(STRING_INSTRUCTION8086(XCHG)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x88] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x89] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x8a] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x8b] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x8c] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x8d] = STRING_INSTRU(STRING_INSTRUCTION8086(LEA)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x8e] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | MOD_RM_REG_MASK | DISP_LOW_MASK | DISP_HIGH_MASK,

    [0x8f] = STRING_INSTRU(STRING_INSTRUCTION8086(POP)) | MOD_RM_REG_MASK,
    ...
    [0x9a] = STRING_INSTRU(STRING_INSTRUCTION8086(CALL)) | DISP_LOW_MASK | DISP_HIGH_MASK | INMED16_MASK | DIS_HIGH_MASK,
    ...
    [0xa0] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | INMED8_MASK ,

    [0xa1] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | INMED16_MASK ,

    [0xa2] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | INMED8_MASK ,

    [0xa3] = STRING_INSTRU(STRING_INSTRUCTION8086(MOV)) | INMED16_MASK ,
